                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$new_blog->title}}</td>
                            <td>{{$new_blog->description}}</td>
                            <td>
                                <img src="uploads/{{$new_blog->image}}" style="width:100px;height:60px" >
                            </td>
                            <td>
                                <a href="{{route('blog.edit'   , ['id'=>$new_blog->id])}}" class="btn btn-info">Edit</a>
                                <a href="{{route('blog.delete' , ['id'=>$new_blog->id])}}" class="btn btn-danger">Delete</a>
